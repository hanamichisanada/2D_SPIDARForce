...
int motor0 = 2;  //モータ0
int enc0a = 18;   //モータ0エンコーダa相
int enc0b = 19;   //モータ0エンコーダb相 

int motor1 = 4;  //モータ1
int enc1a = 14;   //モータ1エンコーダa相
int enc1b = 27;   //モータ1エンコーダb相

int motor2 = 33;  //モータ2
int enc2a = 35;   //モータ2エンコーダa相
int enc2b = 34;   //モータ2エンコーダb相

int motor3 = 32;  //モータ3
int enc3a = 36;   //モータ3エンコーダa相
int enc3b = 39;   //モータ3エンコーダb相
